    ...
    <div className="min-h-screen bg-[#0a0a0f] text-gray-100">
      ...
      <Section id="book" className="max-w-4xl mx-auto px-6 py-20">
        <div className="rounded-2xl bg-gradient-to-br from-blue-600/10 to-purple-600/10 border border-blue-600/20 p-10 md:p-16 text-center">
          ...
          <a href="https://calendly.com/belkenbot/discovery-call" target="_blank" rel="noopener" className="inline-flex items-center gap-2 px-10 py-5 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl text-xl transition-all hover:scale-105">
            Book Your Free Call
          ...
          <div className="grid md:grid-cols-3 gap-8 items-start">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-gray-400">
                ...
                <a href="https://calendly.com/belkenbot/discovery-call" target="_blank" rel="noopener" className="block hover:text-white transition">Book a Call</a>
